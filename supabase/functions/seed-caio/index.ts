// One-shot: cria usuário cliente Caio Daltro.
import { createClient } from "https://esm.sh/@supabase/supabase-js@2.45.0";

const EMAIL = "caio.daltro@rededaltro.com.br";
const PASSWORD = "12345678";
const NAME = "Caio Daltro";
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const { error: upsertErr } = await admin
      .from("profiles")
      .upsert(
        { id: userId, email: EMAIL, full_name: NAME, role: "client" },
        { onConflict: "id" },
      );
